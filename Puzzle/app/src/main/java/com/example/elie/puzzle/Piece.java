package com.example.elie.puzzle;

/**
 * Created by Elie on 12/13/2015.
 */
...
public class Piece {
    ...
    private int offset = 0; // correct orientation. 90 degrees turned clockwise  = 1. 180 degrees turned clockwise = 2. 270 degrees turned clockwise = 3.
