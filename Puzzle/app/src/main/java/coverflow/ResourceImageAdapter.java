...
import com.example.elie.puzzle.R;
...
public class ResourceImageAdapter extends AbstractCoverFlowImageAdapter {
    ...
    private static final int[] DEFAULT_RESOURCE_LIST = { R.drawable.noimage,
            R.drawable.noimage, R.drawable.noimage, R.drawable.noimage,
            R.drawable.noimage };
